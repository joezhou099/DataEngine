...
acc1 = round(clf1.score(train_features, train_labels), 6)
print(u'LOGISTIC REGRESSION score 准确率为 %.4lf' % acc1)
...
acc2 = round(clf2.score(train_features, train_labels), 6)
print(u'SVM score 准确率为 %.4lf' % acc2)
pred2 = clf2.predict(test_features)

# 方法三 决策树
clf3 = DecisionTreeClassifier(criterion='entropy')
clf3.fit(train_features, train_labels)
acc3 = round(clf3.score(train_features, train_labels), 6)
print(u'决策树 score 准确率为 %.4lf' % acc3)
...
acc4 = round(clf4.score(train_features, train_labels), 6)
print(u'随机森林score 准确率为 %.4lf' % acc4)
